(() => {
  ...
  new RoomDisplay({button:$('toggle-fullscreen'),status:$('display-status'),onChange:()=>{closeMenu();interaction.reset();rotateLayout();requestAnimationFrame(rotateLayout);$('toggle-fullscreen').focus({preventScroll:true});}});
